...
function editorMode(type) { if (['feature-list','list'].includes(type)) return 'feature-list'; if (['cards','card-grid'].includes(type)) return 'cards'; if (type === 'ai-preview') return 'ai-preview'; if (type === 'network-visual' || !supportedBlockTypes.has(type)) return 'raw'; return type; }
