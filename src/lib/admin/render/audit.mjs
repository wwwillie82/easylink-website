...
import { ADMIN_TIME_ZONE, adminDateTimeClientSource } from '../date-time.mjs';
...
<p class="hint audit-filter-help">A cél típusa azt jelzi, milyen rendszerobjektumot érintett a művelet. Tartalmi blokknál a Cél ID a blokk azonosítója; a külön Oldal oszlop mutatja a szülőoldalt. A Cél ID és a Request ID mezőben az azonosító egy részlete is elegendő.</p>
</form>
<div class="admin-table-scroll"><table id="audit-table"><thead><tr><th>Időpont</th><th>Felhasználó</th><th>Esemény</th><th>Terület</th><th>Művelet</th><th>Cél típusa</th><th>Cél ID</th><th>Cél neve</th><th>Oldal</th><th>Eredmény</th><th>Request ID</th><th>Részletek</th></tr></thead><tbody><tr><td colspan="12">Betöltés…</td></tr></tbody></table></div>
