...
function scopeForCurrent(current) { if (current.startsWith('/admin/pages')) return 'pages'; if (current === '/admin/menu') return 'menu'; if (current === '/admin/media') return 'media'; if (current === '/admin/settings') return 'settings'; if (current === '/admin/publish') return 'publish'; return ''; }
