...
.media-item img,.media-item video,.media-placeholder{display:block;width:100%;height:150px;object-fit:cover;border-radius:12px;background:#eef3ee}
.media-item video{max-width:100%;outline:0}
