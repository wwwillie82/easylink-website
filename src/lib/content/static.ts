...
export const staticPages: SitePage[] = [
  ...
  { route: '/megoldasaink/', slug: 'megoldasaink', type: 'solutions_index', title: 'Megoldásaink', seoTitle: 'Megoldásaink | Easylink', seoDescription: 'Easylink ügyviteli megoldások.', heroEyebrow: 'Megoldásaink', heroTitle: 'Egy rendszer a napi működés kulcspontjaira.', heroDescription: 'Válaszd ki, melyik működési területet szeretnéd átláthatóbbá tenni: pénzügy, HR, CRM, dokumentumkezelés, kontrolling vagy AI támogatás.', heroAsset: '/assets/nati/hero-bg-flow-01.webp', status: 'published', sortOrder: 10, presentation: { heroVariant: 'listing' }, blocks: [{ type: 'cards', title: '', body: '', presentation: { sectionGroupKey: 'static-solutions-listing-main', sectionTheme: 'light', layout: 'grid', columnPosition: 1, blockChrome: 'none' }, items: publishedSolutions.map((item) => ({ target_type: 'legacy', title: item.title, text: item.shortDescription, href: detailRoute('megoldasaink', item) })) }] },
