...
assert.match(homeSource, /<Hero[\s\S]*<ListingCards[\s\S]*<AiAssistantPreview[\s\S]*<IntegrationsStrip[\s\S]*<ListingCards[\s\S]*<CTASection/, 'home component order must remain unchanged through CTASection');
