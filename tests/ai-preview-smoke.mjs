...
assert.match(component, /AI üzleti pillanatkép/);
assert.match(component, /AI ASSZISZTENS DEMÓ/);
assert.match(component, /Példa arra, hogyan emelhet ki az Easylink AI kockázatokat/);
assert.match(component, /Az Easylink AI-rétege/);
