...
assert.match(component, /const width = isFlow \? 1360 : 1240/);
assert.match(component, /const height = isFlow \? 720 : 760/);
assert.match(component, /const flowColumns = \[140, 380, 660, 940, 1220\]/);
assert.match(component, /const flowLanes = \[130, 300, 500, 620\]/);
assert.match(component, /const flowRoleColumn = \{ user: 0, 'data-source': 0, core: 2, module: 1, external: 4, ai: 3 \}/);
...
assert.match(component, /splitKindLines/);
assert.match(component, /KÖZPONTI', 'RENDSZER/);
assert.match(component, /const edgeLabelBoxWidth = 126/);
